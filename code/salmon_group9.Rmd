...
```{r}
#initial wrangling, making sure salmon columns are numeric and NAs are replaced with 0. Also converting date column from a character class to a date character using lubridate
